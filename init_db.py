...
def init_db_with_sqlalchemy():
    ...
    with app.app_context():
        ...
        testimonials = [
            ...
            Testimonial(customer_name='John Smith', customer_location='Nakuru', testimonial_text='Fast delivery and amazing pastries. Highly recommended!', rating=4, image_url=None, is_approved=False),
            Testimonial(customer_name='Sarah Lee', customer_location='Mombasa', testimonial_text='I loved the cookies, but the bread was a bit dry.', rating=3, image_url=None, is_approved=False),
