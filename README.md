...
#features
* **Dynamic Product Display**: Fetches and displays product information directly from the SQLite database
...
#design-resources
To aid in the design and planning phases of this project, the following tools were utilised
